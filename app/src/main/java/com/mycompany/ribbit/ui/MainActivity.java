...
import com.mycompany.ribbit.adapters.SectionsPagerAdapter;
...
public class MainActivity extends ActionBarActivity implements ActionBar.TabListener{
    ...
    protected DialogInterface.OnClickListener mDialogListener = new DialogInterface.OnClickListener() {
            ...
            switch(which){
                ...
                case 1:
                    ...
                    if(mMediaUri == null){
                        ...
                        videoIntent.putExtra(MediaStore.EXTRA_DURATION_LIMIT, 10);// 10sec limit
        ...
        private Uri getOutputMediaFileUri(int mediaType) {
            ...
            // using the Environment.getExternalStorageState() before doing this.
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(resultCode == RESULT_OK){
            ...
            //adding file type of the file to the intent for recipients Activity
            String fileType;
